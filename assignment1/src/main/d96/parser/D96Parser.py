...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\16\7\3\2\2\16\17\7\62\2\2\17\20\7\63\2\2\20\22\7\64\2")
        buf.write("\2\21\23\5\6\4\2\22\21\3\2\2\2\22\23\3\2\2\2\23\24\3\2")
        buf.write("\2\2\24\25\7\65\2\2\25\26\7\2\2\3\26\3\3\2\2\2\27\30\t")
        buf.write("\2\2\2\30\5\3\2\2\2\31\32\5\n\6\2\32\33\7\66\2\2\33\7")
        buf.write("\3\2\2\2\34\37\5\n\6\2\35\37\7\61\2\2\36\34\3\2\2\2\36")
        buf.write("\35\3\2\2\2\37\t\3\2\2\2 !\7\60\2\2!#\7\62\2\2\"$\5\b")
        buf.write("\5\2#\"\3\2\2\2#$\3\2\2\2$%\3\2\2\2%&\7\63\2\2&\13\3\2")
        buf.write("\2\2\5\22\36#")
        return buf.getvalue()
...
class D96Parser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'main'", "'int'", "'void'", "'Constructor'", 
                     "'Destructor'", "'Class'", "'If'", "'Elseif'", "'Else'", 
                     "'Foreach'", "'In'", "'By'", "'True'", "'False'", "'Null'", 
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "INTTYPE", "VOIDTYPE", "CONSTRUCTOR", 
                      "DESTRUCTOR", "CLASS", "IF", "ELSEIF", "ELSE", "FOREACH", 
                      "IN", "BY", "TRUE", "FALSE", "NULL", "ARRAY", "INT", 
                      "FLOAT", "BOOLEAN", "STRING", "VAL", "VAR", "RETURN", 
                      "BREAK", "CONTINUE", "ADD", "SUB", "MUL", "DIV", "REM", 
                      "NOT", "AND", "OR", "NEQ", "EQUAL", "GT", "LTE", "LT", 
                      "GTE", "CONCAT", "STREQUAL", "DOUSEMI", "DOT", "NEW", 
                      "ASSIGN", "ID", "INTLIT", "LB", "RB", "LP", "RP", 
